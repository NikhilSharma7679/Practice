...
import 'CoachSignupViewModel.dart';
...
class _CoachSignupViewState extends State<CoachSignupView> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<CoachSignupViewModel>.reactive(
      viewModelBuilder: () => CoachSignupViewModel(),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  await viewModel.getRegisterationDetails(
